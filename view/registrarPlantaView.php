    ...
    <div class="card shadow p-4" style="max-width: 600px; margin: 0 auto;">
        ...
        <form method="POST" action="?controlador=Planta&accion=registrar">
            <div class="mb-3">
                ...
                <input type="text" name="nombre_cientifico" class="form-control form-control-lg" placeholder="Ej: Quercus robur" required autofocus>
            </div>
            <div class="mb-3">
                <label class="form-label fw-bold">Nombre Común (Opcional)</label>
                <input type="text" name="nombre_comun" class="form-control" placeholder="Ej: Roble">
            </div>
