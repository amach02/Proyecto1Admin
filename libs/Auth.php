...
class Auth {
    ...
    private static $permisos = array(
        ...
        'Curador' => array(
            'Especimen'  => array('mostrarListar', 'mostrarRegistrar', 'registrar',
                                  'mostrarEditar', 'editar', 'buscarPorCodigo',
                                  'rutaFisica', 'vincularPlanta'),
            'Taxonomia'  => array('mostrar'),
            'Orden'      => array('mostrarListar', 'mostrarRegistrar', 'registrar',
                                  'mostrarEditar', 'editar'),
            'Familia'    => array('mostrarListar', 'mostrarRegistrar', 'registrar',
                                  'mostrarEditar', 'editar'),
            'Genero'     => array('mostrarListar', 'mostrarRegistrar', 'registrar',
                                  'mostrarEditar', 'editar'),
            'Especie'    => array('mostrarListar', 'mostrarRegistrar', 'registrar',
                                  'mostrarEditar', 'editar'),
    ...
    private static $publicas = array(
        'Session' => array('mostrarLogin', 'login'),
    );
